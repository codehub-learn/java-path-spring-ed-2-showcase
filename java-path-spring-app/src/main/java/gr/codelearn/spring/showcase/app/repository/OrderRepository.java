...
public interface OrderRepository extends JpaRepository<Order, Long> {
	...
	@Query("select new gr.codelearn.spring.showcase.app.transfer.KeyValue(concat(c.lastname, ' ', c.firstname), " +
			"avg(o.cost)) from Order o join o.customer c group by c.lastname, c.firstname")
